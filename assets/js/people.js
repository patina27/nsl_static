...
function getVisitProfs()
{
	var onSuccess = function(data)
	{
		var column = document.getElementById('visitProfsRow');
	...
	makeGetRequest('visiting_profs',onSuccess,onFailure);
}

function getVisitStuds()
{
	var onSuccess = function(data)
	{
		var column = document.getElementById('visitStudsRow');
	...
	makeGetRequest('visiting_studs',onSuccess,onFailure);
}